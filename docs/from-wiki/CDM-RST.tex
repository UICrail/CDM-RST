...
assume that data are complete, we only accept positive information
telling that it is complete. Here, the fact that a list element does not
point to any next element has no meaning. After all, the next element
could simply be unknown and get discovered later.}
